...
lyr_TerrorAttacks_2.set('fieldAliases', {'rowid': 'rowid', 'Region': 'Region', 'Date & Time': 'Date & Time', 'Perpetrator group': 'Perpetrator group', 'Target': 'Target', 'Attack Type': 'Attack Type', 'Weapon Type': 'Weapon Type', 'Fatalities': 'Fatalities', 'Injured': 'Injured', 'Report': 'Report', 'Media': 'Media', });
...
lyr_TerrorAttacks_2.set('fieldImages', {'rowid': 'TextEdit', 'Region': 'TextEdit', 'Date & Time': 'DateTime', 'Perpetrator group': 'TextEdit', 'Target': 'TextEdit', 'Attack Type': 'TextEdit', 'Weapon Type': 'TextEdit', 'Fatalities': 'Range', 'Injured': 'Range', 'Report': '', 'Media': 'TextEdit', });
...
lyr_TerrorAttacks_2.set('fieldLabels', {'rowid': 'hidden field', 'Region': 'inline label - always visible', 'Date & Time': 'inline label - always visible', 'Perpetrator group': 'inline label - always visible', 'Target': 'inline label - always visible', 'Attack Type': 'inline label - always visible', 'Weapon Type': 'inline label - always visible', 'Fatalities': 'inline label - always visible', 'Injured': 'inline label - always visible', 'Report': 'no label', 'Media': 'inline label - always visible', });
